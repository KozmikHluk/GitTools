...
copy %PROJ%\Recruiting.rar "%P2%\Recruiting_TEST_%YYYY%-%MM%-%DD%.rar"
copy %PROJ%\knowledge.ultipro.com.rar "%P3%\knowledge.ultipro.com_TEST_%YYYY%-%MM%-%DD%.rar"





CALL GITExport_TEST.cmd
:END
PAUSE