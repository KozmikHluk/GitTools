@ECHO OFF
ECHO -------------------------------------------------------------------
ECHO --  You are starting the Git to Git migration                  ----
ECHO --  Creates local git repo and creates the repository          ----
ECHO --  on the cloud repo at end                                   ----
ECHO -------------------------------------------------------------------
...
IF %REPO_NAME%==SBI SET GITPROJ=BI
